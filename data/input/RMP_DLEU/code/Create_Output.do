...
graph export BW/Fig3b.eps, replace
restore
preserve
drop if mu_1<0.5
drop if mu_1> 3.5
...
graph export BW/Fig3a.eps, replace
restore
*---------------------------------------------------------------------------------------------------------------------------*
...
graph export BW/Fig4.eps, replace
restore
*---------------------------------------------------------------------------------------------------------------------------*
...
graph export BW/Fig5.eps, replace
restore
*---------------------------------------------------------------------------------------------------------------------------*
...
graph export BW/Fig7.eps, replace
restore
*---------------------------------------------------------------------------------------------------------------------------*
...
graph export BW/Fig8a.eps, replace
restore
preserve
drop if pi_rate2<-.15
drop if pi_rate2> .55
...
graph export BW/Fig8b.eps, replace
restore
*---------------------------------------------------------------------------------------------------------------------------*
...
graph export Fig09a.eps, replace
...
graph export BW/Fig09a.eps, replace
...
graph export BW/Fig9b.eps, replace
restore
*---------------------------------------------------------------------------------------------------------------------------*
...
, xlabel(.1 .2 .3) legend(ring(0) pos(11) col(1))
graph export BW/Fig10a.eps, replace
...
, xlabel(.1 .2 .3) legend(ring(0) pos(11) col(1))
graph export BW/Fig10b.eps, replace
}
restore
*---------------------------------------------------------------------------------------------------------------------------*
...
graph export BW/Fig11.eps, replace
restore
*---------------------------------------------------------------------------------------------------------------------------*
...
graph export Fig12a.eps, replace
...
graph export BW/Fig12a.eps, replace
...
graph export Fig12b.eps, replace
...
graph export BW/Fig12b.eps, replace
restore
*---------------------------------------------------------------------------------------------------------------------------*
...
graph export Fig13a.eps, replace
...
graph export BW/Fig13a.eps, replace
...
graph export Fig13b.eps, replace
...
graph export BW/Fig13b.eps, replace
restore
*---------------------------------------------------------------------------------------------------------------------------*
...
graph export Fig14a.eps, replace
...
graph export BW/Fig14a.eps, replace
...
graph export Fig14b.eps, replace
...
graph export BW/Fig14b.eps, replace
restore
*---------------------------------------------------------------------------------------------------------------------------*
...
graph export Fig15a.eps, replace
...
graph export BW/Fig15a.eps, replace
forvalues s=1/2 {
...
graph export Fig15b.eps, replace 
...
graph export BW/Fig15b.eps, replace 
restore
*---------------------------------------------------------------------------------------------------------------------------*
...
graph export Fig16a.eps, replace
...
graph export BW/Fig16a.eps, replace
...
graph export Fig16b.eps, replace
...
graph export BW/Fig16b.eps, replace
...
graph export Fig16c.eps, replace
...
graph export BW/Fig16c.eps, replace
...
graph export Fig16d.eps, replace
...
graph export BW/Fig16d.eps, replace
restore
*---------------------------------------------------------------------------------------------------------------------------*
...
graph export Fig17a.eps, replace
...
graph export BW/Fig17a.eps, replace
restore
* again for empl.
preserve
* cutt-off year
...
label var reall_inc_s "Reallocation
scatter MU_agg Dagg_sum  reall_inc_s Net_s   year , c(l l l l) lwidth(thick thick thick thick) lpattern(solid dash shortdash longdash_dot)  lcolor(red blue black green) xlabel(1980 1990 2000 2010) msymbol(none none none none none) sort xtitle("") legend(ring(0)  pos(11) ) 
graph export Fig17b.eps, replace
scatter MU_agg Dagg_sum  reall_inc_s Net_s   year , c(l l l l) lwidth(thick thick thick thick) lpattern(solid dash shortdash longdash_dot)  lcolor(black black black black) xlabel(1980 1990 2000 2010) msymbol(none none none none none) sort xtitle("") legend(ring(0)  pos(11) ) 
graph export BW/Fig17b.eps, replace
restore
*-------------------------------------------------------------------------------------------------------------------------*
* APPENDIX
cd "$dropbox"
...
graph export FigC1a.eps, replace
...
graph export BW/FigC1a.eps, replace
sort year
drop if year==year[_n-1]
...
graph export FigC1b.eps, replace
...
graph export BW/FigC1b.eps, replace
restore
*-------------------------------------------------------------------------------------------------------------------------*
* Appendix D
...
graph export FigD1.eps, replace
...
graph export BW/FigD1.eps, replace
restore
*-------------------------------------------------------------------------------------------------------------------------*
* Appendix E
...
graph export BW/FigE1.eps, replace
restore
*-------------------------------------------------------------------------------------------------------------------------*
* Appendix F 
...
graph export FigF1a.eps, replace
...
graph export BW/FigF1a.eps, replace
...
graph export FigF1b.eps, replace
...
graph export BW/FigF1b.eps, replace
restore
*-------------------------------------------------------------------------------------------------------------------------*
...
graph export Fig6a.eps, replace
...
graph export BW/Fig6a.eps, replace
...
graph export Fig6b.eps, replace
...
graph export BW/Fig6b.eps, replace
*2. retail
...
graph export Fig6c.eps, replace
...
graph export BW/Fig6c.eps, replace
...
graph export Fig6d.eps, replace
...
graph export BW/Fig6d.eps, replace
*3. wholesale
...
graph export Fig6e.eps, replace
...
graph export BW/Fig6e.eps, replace
...
graph export Fig6f.eps, replace
...
graph export BW/Fig6f.eps, replace
*
*-------------------------------------------------------------------------------------------------------------------------*
}
*-------------------------------------------------------------------------------------------------------------------------*
