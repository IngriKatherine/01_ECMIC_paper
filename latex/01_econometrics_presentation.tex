...
\centering
\includegraphics[width=\textwidth, height=0.85\textheight, keepaspectratio]{violin_markdown_ownwshare.png}
\end{frame}
...
%%%%%%----------------------%%%%%%
\begin{frame}{Gauss-Markov Multiple Regression Assumptions}
\centering
\includegraphics[width=\textwidth, height=0.9\textheight, keepaspectratio]{lm_diagnostics.png}
\end{frame}
